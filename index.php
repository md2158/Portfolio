    ...
    <nav class="navbar">
      <div class="container">
        ...
        <ul class="list-unstyled">
          ...
          <li>
            <a href="https://github.com/merick2158">
    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-12 px-4 pb-4 pt-1">
          ...
          <!-- <p class="mb-1 text-center"><b>Contact Us: m(at)denet(dot)pro</b></p> -->
          <!-- <div class="text-center"><a href="https://github.com/merick2158" target="_blank"><i class="fab fa-2x fa-github"></i></a></div> -->
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
            <div class="ow-item">
              ...
              <a href="https://meret.pro/works/dtourism/" class="ow-link" target="_blank">
                <i class="fas fa-globe"></i>
                <i class="fab fa-wordpress"></i>
