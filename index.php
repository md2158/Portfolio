      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-12 px-4 pb-4 pt-1">
            ...
            <hr/>
            <p class="mb-0 text-center"><b>Contact Us: m(at)denet(dot)pro</b></p>
            <hr/>
          ...
          <div class="col-md-4 col-12 text-center logo px-5">
            <!-- <?php echo file_get_contents('img/logo-mpro.svg'); ?> -->
          </div>
        </div>
      </div>
    </div>
