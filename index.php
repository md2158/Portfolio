          ...
          <div class="col-12 order-1 order-md-2">
              <?php
                $works = array(
                    ...
                    array("title" => "Beauty Shkaf Shop", "imgUrl" => "img/works/beauty-shkaf.jpg", "url" => "https://beautyshkaf.shop/", "urlText" => "beautyshkaf.shop", "icons" => array("fab fa-wordpress", "fas fa-shopping-basket")),
                    ...
                    array("title" => "Lovince", "imgUrl" => "img/works/lowence.jpg", "url" => "https://lovince.ru/", "urlText" => "lovince.ru", "icons" => array("fas fa-globe")),
